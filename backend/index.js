...
// set up the google cloud auth 
const auth = new GoogleAuth({
  scopes: ["https://www.googleapis.com/auth/cloud-platform"],
});
const PROJECT_ID = process.env.GCP_PROJECT_ID;
const REGION = process.env.GCP_REGION || "us-central1"; //not sure if its needed yes i guess for the url call 
...
//upload the files that we just fetched
...
// generate look with Vertex AI Try-On 
app.post(
  "/generate-look",
  upload.fields([
